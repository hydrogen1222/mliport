...
from mliport.analysis.validation import UnsupportedAnalysisError, require_analysis
...
def periodic_rmsd_rmsf(
    ...
    *,
    ...
    from mliport.analysis.msd import displacement_trajectory  # noqa: PLC0415
