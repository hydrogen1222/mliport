...
Unlike :mod:`mliport.gpu_compat` (which does compute-capability *math* against an
...
The single source of GPU classification is :data:`mliport.install.compatibility.ARCH_PROFILES`.
...
from mliport.install.compatibility import classify_gpu
