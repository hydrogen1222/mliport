...
- The packaged curated registry (``mlipx/data/validation/*.json``,
  schema ``mlipx.capability-evidence/1``) carries only the fields the
  capability resolver needs. It ships inside the wheel so an installed mlipx
...
CURATED_EVIDENCE_SCHEMA = "mlipx.capability-evidence/1"
