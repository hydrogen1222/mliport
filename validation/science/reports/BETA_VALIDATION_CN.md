...
由 `.validation-work` 下的证据记录生成；对应提交 `293c1ed36f6aea843929e4d3ca2fe1da9c5e88bc`。本文档全部表格由 `validation/science/scripts/generate_beta_report.py` 从结果 JSON 渲染，更新方式是重新生成并 diff，不要手工编辑。
