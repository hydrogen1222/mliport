"""Tests for mliport.install.sources — source profiles and uv arg builders."""
...
def test_managed_profile_removes_inherited_resolver_settings(name):
    from mliport.install.sources import source_environment
...
def test_custom_source_preserved_and_preview_redacts_credentials():
    from mliport.install.sources import source_environment, source_environment_summary
